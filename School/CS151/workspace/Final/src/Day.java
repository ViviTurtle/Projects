...
public class Day {
	 ...
	 */
	public Day(int aMonth, int aDate, int aYear) {
		year = aYear;
		month = aMonth;
		date = aDate;
	}
	...
	/**
	 * Converts user input in format (MM/DD/YYYY) to Day object
	 * 
	 * @param typed
	 *            the user input
	 * @return the day created from the user input
	 */
	public static Day inputToDay(String typed) {
		Day date = new Day(Integer.parseInt(typed.substring(0, 2)),
				Integer.parseInt(typed.substring(3, 5)), Integer.parseInt(typed
						.substring(typed.length() - 4)));
		return date;
	}

	/**
	 * Converts this day to String format as mm/dd/yyyy
	 * 
	 * @return this day in String format
	 */
